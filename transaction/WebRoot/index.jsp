...
<%@ page import="com.wxh.dao.MessageDAO"%>
<%@ page import="com.wxh.factory.MessageDAOFactory"%>
<%@ page import="com.wxh.util.Page"%>
<%@ page import="com.wxh.util.PageUtil"%>
<%@ page import="com.wxh.bean.Message"%>
